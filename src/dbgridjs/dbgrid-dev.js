(function () {
  ...
  DBGrid.prototype = {
    ...
    createTableFootData: function (props) {
      ...
      console.log("--createTableFootData--");
      console.log("props.selectedPageIndex " + props.selectedPageIndex);
      console.log("props.pagerCount " + props.pagerCount);
    ...
    on: {
      ...
      pageIndexChange: function (sender, event) {
        ...
        let selectedPageIndex = Number(value);
